...
@property (nonatomic, strong) MJRefreshBackNormalFooter * myRefreshFooter;
...
-(MJRefreshBackNormalFooter *)myRefreshFooter{
    if (!_myRefreshFooter) {
        _myRefreshFooter =  [MJRefreshBackNormalFooter footerWithRefreshingBlock:^{
           self.page += 1;
           [self requestList];
        }];
